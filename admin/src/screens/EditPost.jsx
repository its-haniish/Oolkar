...
const EditPost = () => {
    ...
    const getPostInfo = async () => {
        setLoading(true);
        try {
            const res = await fetch(`${process.env.REACT_APP_BASE_URL}/get-post`, {
                method: 'POST',
            ...
            const { title, featured, author, slug: postSlug, contents, metaDescription, keywords } = result.response;
            setFormData({ title, featured, author, slug: postSlug, metaDescription, keywords });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`${process.env.REACT_APP_BASE_URL}/update-post`, {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
